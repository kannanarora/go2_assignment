...
def generate_launch_description():
    ...
    requested_behaviour_topic = LaunchConfiguration("requested_behaviour_topic")
    cooldown_sec = LaunchConfiguration("cooldown_sec")

    return LaunchDescription([
        DeclareLaunchArgument("text_topic", default_value="/go2/whisper/text"),
        DeclareLaunchArgument(
            "requested_behaviour_topic", default_value="/requested_behaviour"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "requested_behaviour_topic": requested_behaviour_topic,
